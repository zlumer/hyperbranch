...
import { get as root__get, post as root__post } from "./routes/root.js"
import { del as id_index__del, get as id_index__get, patch as id_index__patch } from "./routes/{id}/index.js"
import { get as id_logs__get } from "./routes/{id}/logs.js"
import { get as id_models__get } from "./routes/{id}/models.js"
import { post as id_run__post } from "./routes/{id}/run.js"
import { get as id_runs_index__get } from "./routes/{id}/runs/index.js"
import { get as id_runs_status__get } from "./routes/{id}/runs/status.js"
import { get as id_runs_runId_files__get } from "./routes/{id}/runs/{runId}/files.js"
import { del as id_runs_runId_index__del } from "./routes/{id}/runs/{runId}/index.js"
import { get as id_runs_runId_logs__get } from "./routes/{id}/runs/{runId}/logs.js"
import { post as id_runs_runId_merge__post } from "./routes/{id}/runs/{runId}/merge.js"
import { get as id_runs_runId_port__get } from "./routes/{id}/runs/{runId}/port.js"
import { post as id_runs_runId_pull__post } from "./routes/{id}/runs/{runId}/pull.js"
import { post as id_runs_runId_resume__post } from "./routes/{id}/runs/{runId}/resume.js"
import { get as id_runs_runId_session__get } from "./routes/{id}/runs/{runId}/session.js"
import { post as id_runs_runId_stop__post } from "./routes/{id}/runs/{runId}/stop.js"
import { post as id_runs_runId_sync__post } from "./routes/{id}/runs/{runId}/sync.js"
